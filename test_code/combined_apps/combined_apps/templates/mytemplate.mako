...
<head>
  ...
  <link rel="shortcut icon" href="${request.static_url('combined_apps:static/favicon.ico')}" />
  <link rel="stylesheet" href="${request.static_url('combined_apps:static/pylons.css')}" type="text/css" media="screen" charset="utf-8" />
  <link rel="stylesheet" href="http://static.pylonsproject.org/fonts/nobile/stylesheet.css" media="screen" />
  <link rel="stylesheet" href="http://static.pylonsproject.org/fonts/neuton/stylesheet.css" media="screen" />
  <!--[if lte IE 6]>
  <link rel="stylesheet" href="${request.static_url('combined_apps:static/ie6.css')}" type="text/css" media="screen" charset="utf-8" />
  <![endif]-->
</head>
<body>
  <div id="wrap">
    <div id="top">
      <div class="top align-center">
        <div><img src="${request.static_url('combined_apps:static/pyramid.png')}" width="750" height="169" alt="pyramid"/></div>
      </div>
    </div>
    <div id="middle">
      <div class="middle align-center">
        ...
        <p>
          <a href="${request.route_url('blog.home')}">Blog</a>
        </p>
      </div>
    </div>
    <div id="bottom">
